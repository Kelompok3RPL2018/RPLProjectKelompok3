...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2018 at 04:30 AM
...
INSERT INTO `booking` (`fk_customer_id`, `fk_instruments_id`, `pieces`, `date`, `days`, `status`) VALUES
(1, 16, 3, '2019-01-02 14:04:00', 0, 1),
(1, 3, 4, '2019-01-01 13:01:00', 4, 0),
(5, 2, 4, '2018-06-29 13:01:00', 3, 1);
...
INSERT INTO `customer` (`customer_id`, `firstname`, `lastname`, `contact_no`, `gender`, `customer_email`, `address`, `username`, `password`) VALUES
(1, 'fikri', 'hashfi', 85878586091, 'Male', 'fikrihashfi@gmail.com', 'klaten', 'fikri', '123456'),
(5, 'rofli', 'nasuha', 12345, 'Female', 'rofli@gmail.com', 'malaysia', 'rofli', '123456');
...
ALTER TABLE `booking`
  ...
  ADD KEY `fk_instruments_id` (`fk_instruments_id`) USING BTREE;
...
--
ALTER TABLE `admin`
  MODIFY `admin_id` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `instrument`
  MODIFY `id_instrument` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
ALTER TABLE `booking`
  ...
  ADD CONSTRAINT `fk_instruments` FOREIGN KEY (`fk_instruments_id`) REFERENCES `instrument` (`id_instrument`);
COMMIT;
