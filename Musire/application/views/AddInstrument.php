...
<div class="bg-dark center" style="height:100%">
        <div class="p-5 rounded flex-column text-center justify-content-around custom-card-white lobsfont" style="height:80%; width:30%">
            ...
            <?php echo form_open_multipart('Tambah_Instrument');?>
                    ...
                    <div class="form-group row">
                   <label for="upload"></br>Upload File</label>
         ...
         <div class="p-5 rounded flex-column text-center center custom-card" style="height:80%; width:30%">
           <div class="lobsfont">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <small id="priceHelp" class="form-text text-muted">max number : 7.</small>
                     </div>   
